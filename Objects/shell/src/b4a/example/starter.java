...
public static b4a.example.altaproducto _altaproducto = null;
  public Object[] GetGlobals() {
		return new Object[] {"AltaProducto",Debug.moduleToString(b4a.example.altaproducto.class),"Edicion",Debug.moduleToString(b4a.example.edicion.class),"HttpUtils2Service",starter.mostCurrent._httputils2service,"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service};
}
}